...
$this->title = $model->vBusinessName . '\'s Details';
$this->params['breadcrumbs'][] = ['label' => Yii::t('admin', 'unclaimed-business'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
$context = $this->context;
$businessTimings = $model->businessTimings;
$businessPhotos = $model->businessPhotos;
$businessRatings = $model->businessRatings;
?>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#businessDetails" data-toggle="tab"> <?= Yii::t('admin', 'business-details') ?> </a></li>
                        <li><a href="#businessRatingDetails" data-toggle="tab"> <?= Yii::t('admin', 'business-rating-details') ?> </a></li>
                    </ul><br>
                    <div class="tab-content">
                        <!-- /.tab-pane -->
                        <div  class="active tab-pane" id="businessDetails">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    DetailView::widget([
                                        ...
                                        'attributes' => [
                                            ...
                                            [
                                                ...
                                                'value' => function ($model) {
                                                    return $model->vCategoryName ?? 'N/A';
                                                },
                                            ],
                                            [
                                                'attribute' => 'vName',
                            ...
                            <?php if (!empty($businessPhotos) || !empty($model->vLogoPic)) : ?>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        $items = [];
                                        $items[] = [
                                            'url' => Yii::$app->params['BUSINESS_URL'] . $model->iUserId . "/" . $model->vLogoPic,
                                            'src' => Yii::$app->params['BUSINESS_URL'] . $model->iUserId . "/" . $model->vLogoPic,
                                            'options' => []
                                        ];
