...
$this->title = Yii::t('admin', 'user-master');
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                if ($model->tiIsActive == 1) {
                                    return Html::a('&nbsp;&nbsp;Active&nbsp;&nbsp;', ['status-change', 'id' => $model->iUserId, 'type' => 0], [
                                                ...
                                                'data' => [
                                                    'confirm' => Yii::t('app', 'Are you sure you want to <span class="text-danger">Inactive</span> this '.(Yii::t('admin', 'user-master-item')).'?'),
                                                    'method' => 'post',
                                                //'pjax' => true
                                                ],
                                    ]);
                                    ...
                                    return Html::a('Inactive', ['status-change', 'id' => $model->iUserId, 'type' => 1], [
                                                ...
                                                'data' => [
                                                    'confirm' => Yii::t('app', 'Are you sure you want to <span class="text-danger">Active</span> this '.(Yii::t('admin', 'user-master-item')).'?'),
                                                    'method' => 'post',
                                                ],
                                    ]);
                                }
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model) {
                                    ...
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span>', ['delete', 'id' => $model->iUserId], [
                                                ...
                                                'data' => [
                                                    'confirm' => Yii::t('app', 'Are you sure you want to delete this '.(Yii::t('admin', 'user-master-item')).'?'),
                                                    'method' => 'post',
                                                ],
                                    ]);
                                }
                    ...
                    GridView::widget([
                        ...
                        'toolbar' => [
                            ['content' =>
                                ...
                                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['./user-master'], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => 'Reset Grid'])
                            ],
                            '{export}',
                            '{toggleData}',
                        ],
